...
- [UI Guidelines](../docs/ui-guidelines.md) - UI guidelines for the project
- [Testing Guidelines](../docs/testing-guidelines.md) - Testing guidelines for the project
- [Coding Guidelines](../docs/coding-guidelines.md) - Coding guidelines for the project
